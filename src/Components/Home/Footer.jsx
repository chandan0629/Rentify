        ...
        <Box textAlign={"left"}>
          ...
          <Textcomp>
            <Text fontSize={"12px"} color={"#717171"}>
              Rentify is one of India’s best-known rental brands with a
          ...
          <Textcomp>
            <Text fontSize={"12px"} color={"#717171"}>
              Rentify provides very reasonable rental rates, allowing you to
        ...
        >
          ...
          >
            <Text fontSize={"12px"} color={"#717171"} textAlign={"left"}>
              © 2025.ARC private limited. All rights reserved. Rentify is a registered
              trademark of ARC private limited. Rentify is a product of ARC private
              limited.
            </Text>
            <Stack direction={"row"} spacing={6}>
              <SocialButton
                label={"Facebook"}
                href={"https://www.facebook.com/rentify"}
              >
                <CgFacebook />
              </SocialButton>
              <SocialButton
                label={"Twitter"}
                href={"https://twitter.com/rentify"}
              >
                <BsTwitter />
              </SocialButton>
              <SocialButton
                label={"Linkedin"}
                href={"https://www.linkedin.com/company/rentify/"}
              >
                <RiLinkedinFill />
              </SocialButton>
              <SocialButton
                label={"Youtube"}
                href={"https://www.youtube.com/c/RentifyOfficial"}
              >
                <ImYoutube />
              </SocialButton>
              <SocialButton
                label={"Instagram"}
                href={"https://www.instagram.com/rentify/"}
              >
                <TiSocialInstagram />
              </SocialButton>
              <SocialButton
                label={"Dribbble"}
                href={"https://dribbble.com/Rentify"}
              >
                <IoLogoDribbble />
              </SocialButton>
            </Stack>
